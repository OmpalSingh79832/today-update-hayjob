          ...
          <div className='d-flex justify-content-between' style={{ width: "97%" }}>
            ...
            <div>
              <ul className="nav-list">
                ...
                {/* <Link to="/login"> */}
                <li className="nav-item dropdown  ">
                  <span className="dropdown-text border-left-0 border-warning mx-3 "><Login /></span>
                </li>
                {/* </Link> */}
                <li className="nav-item dropdown">
            ...
            <div className="dropdown-text border-left-0 border-warning mx-3 show-login" onClick={() => { navigate("/login-modal") }}>Login</div>
          </div>
        </nav>
      </div>
    </>
